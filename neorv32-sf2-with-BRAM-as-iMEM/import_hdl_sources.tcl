# Import TOP
#import_files -library work -hdl_source ./custom_rtl/neorv32_ProcessorTop_MinimalBoot.vhd
...
#import_files -library neorv32 -hdl_source ./neorv32_application_image.vhd  # This file is commented
...
# Different way to import files
#import_files -library neorv32 -hdl_source ${neorv_rtl_dir}/core/neorv32_package.vhd
#import_files -library neorv32 -hdl_source ${neorv_rtl_dir}/core/neorv32_application_image.vhd
#import_files -library neorv32 -hdl_source ${neorv_rtl_dir}/core/neorv32_bootloader_image.vhd
#import_files -library neorv32 -hdl_source ${neorv_rtl_dir}/core/neorv32_dmem.entity.vhd
#import_files -library neorv32 -hdl_source ${neorv_rtl_dir}/core/neorv32_imem.entity.vhd
