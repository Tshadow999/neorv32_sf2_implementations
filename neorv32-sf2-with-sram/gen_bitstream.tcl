set proj_name "Neorv32-sf2-with-sram"
...
puts "-------------------------------------------------------------------------"
import_files -io_pdc {./constraint_files/SF2_SFM20000_io.pdc} 

source ./system_builder_tcl_files/CreateSmartDesign.tcl
build_design_hierarchy
# Set top entity
set_root -module {top_sd::work} 

run_tool -name {CONSTRAINT_MANAGEMENT} 
organize_tool_files -tool {PLACEROUTE} -file ${prj_dir_name}/constraint/io/SF2_SFM20000_io.pdc -module {top_sd::work} -input_type {constraint} 
